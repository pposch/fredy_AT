 ...
 * @property {boolean} [usesPuppeteer] Whether a custom `getListings` still drives its request through a shared Puppeteer browser (so it should receive the same proxy-configured browser instance as the generic extractor flow).
